...
$cls=$_POST["c2"];
$s=mysqli_query($con,"select name,id from primaryy where class='$cls'");
echo "<form action='test2.php' method='post'><input type='hidden' name='h1' value='$cls'><table border ='1' cellspacing=3 width=40% height=80% align='center' style=margin:90px; bgcolor='pink'>
