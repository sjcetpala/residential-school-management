...
<body>
	...
	$s= "update primaryy set `name`='$name', `class`='$class', `dob`='$dob', `gender`='$gender', `religion`='$religion',`caste`='$caste',`mail`='$mail',`mob`='$mob',`insti`='$insti',`guardian`='$guardian',`father`='$father',`mother`='$mother',`adress`='$adress',`line`='$line',`city`='$city',`zip`='$zip' where mail='$uid'";
			mysqli_query($con,$s);
