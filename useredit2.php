...
<body>
<h1>us<span>er</span><span>fo</span>rm<span>-</span>edi<span>it</span></h1>
<div class="w3ls-main">
<div class="w3ls-form">
<?php
		           $uid=$_SESSION['mail'];
...
<ul class="fields"><tr><td>
	<div class="inputf_left" background="black">
						...
						<div class="inputf_right">
							<input type="text" name="mob" id="mob" value="<?php echo $result['mob']?>" required disabled/></td><td></td>
						<td><div class="inputf_left">
							<input type="label" value="instituition">
						</div>
						<div class="inputf_right">
						<input type="text" name="insti" id="insti" value="<?php echo $result['insti']?>" required disabled/>
						</div>
						<div class="inputf_left">
					...
					<input type="text" name="zip" id="zip" value="<?php echo $result['zip']?>" required disabled/>
						...
						<div class="inputf_right">
						<input type="text" name="option" id="option" value="<?php echo $result['options']?>" required disabled/>
						</tr>
...
<?php
	...
	$s= "update reg_up set `name`='$name', `class`='$class',`mail`='$mail',`mob`='$mob',`insti`='$insti',`guardian`='$guardian',`adress`='$adress',`line`='$line',`city`='$city',`zip`='$zip',`options`='$option' where mail='$uid'";
			mysqli_query($con,$s);
