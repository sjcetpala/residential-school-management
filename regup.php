...
<body>
		...
		<div class="register-form">
			<form action="#" method="post">
				...
				<div class="styled-input">
					...
					<div class="styled-input agile-styled-input-top">
						<span class="fa fa-user" aria-hidden="true"></span>
						<select name="religion" class="category2" required="" >
                  <option value="volvo">christian</option>
                      <option value="saab">Hindu</option>
                     <option value="opel">MUslium</option>
                 <option value="audi">Others</option>
					...
					<div class="styled-input">
				<label class="header">Accademics</label>
				<div class="styled-input agile-styled-input-top">
						<span class="fa fa-user" aria-hidden="true"></span>
						<select name="language" class="category2" required="" >
                  <option value="volvo">2nd language</option>
                 ...
                 <option value="audi">Fr</option>
					...
					<div class="styled-input">
						...
						<span class="fa fa-user" aria-hidden="true"></span>
						<input type="text" placeholder="Marks of last class" name="mark" required="">
					</div>
					</div>
				...
				<div class="styled-input agile-styled-input-top">
						<span class="fa fa-user" aria-hidden="true"></span>
						<select name="title" class="category2" required="" >
                 ...
                 <option value="audi">Fr</option>
					...
					<div class="styled-input">
						<span class="fa fa-user" aria-hidden="true"></span>
						<input type="text" placeholder="Name of the Guardian" name="gname" required="">
					</div>
					<div class="styled-input">
						<span class="fa fa-user" aria-hidden="true"></span>
						<input type="text" placeholder="Relationship to the student" name="rname" required="">
					</div>
					<div class="styled-input">
						<span class="fa fa-user" aria-hidden="true"></span>
	...
	$s= "INSERT INTO `reg_up`( `name`, `class`, `dob`, `gender`, `religion`, `caste`, `mail`, `mob`,`language`, `insti`, `mark`, `adress`, `line`, `city`, `zip`, `title`,  `guardian`, `relation`, `father`, `mother`,  `options`,`Room_status`) VALUES ('$name','$class','$dob','$gender','$religion','$caste','$mail','$mob','$language','$insti','$mark','$adress','$line','$city','$zip','$title','$guardian','$relation','$father','$mother','$opt1','$room')";
			mysqli_query($con,$s);
