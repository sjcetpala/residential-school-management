...
<body>
	...
	<div class="top-bar_sub_w3layouts_agile">
		...
		<div class="search">
			<h5><a class="sign" href="#" data-toggle="modal" data-target="#myModal2">Reset password</a></h5>
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<nav>
							<ul class="top_nav">
								...
								<li class="dropdown">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="Pages" role="button" aria-haspopup="true" aria-expanded="false">Profile<span class="fa fa-angle-down"></span></a>
									<ul class="dropdown-menu">
										<li><a href="edit1.php">Primary</a></li>
										<li><a href="edit2.php">Upper primary</a></li>
										<li><a href="reghigher.php">higher secondary</a></li>
									</ul>
								</li>
								<li class="dropdown">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="Pages" role="button" aria-haspopup="true" aria-expanded="false">Application<span class="fa fa-angle-down"></span></a>
									<ul class="dropdown-menu">
										<li><a href="regnew.php">Primary</a></li>
										<li><a href="regup.php">Upper primary</a></li>
										<li><a href="reghigher.php">higher secondary</a></li>
									</ul>
								</li>
								<li><a href="messuser.php">messBill</a></li>
								<li><a href="contact.html">Contact</a></li>
								<li><a href="aaa.php">Marks</a></li>
							</ul>
						</nav>
					</div>
				</nav>
					...
					<div class="signin-form profile">
						...
						<div class="login-m_page">
							...
							<div class="login-form-wthree-agile">
								<form action="passdemo.php" method="post">
