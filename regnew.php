...
<body>
	...
	$s= "insert into primaryy (name,class,dob,gender,religion,caste,mail,mob,insti,guardian,father,mother,adress,line,city,zip,Room_status) values('$name','$class','$dob','$gender','$religion','$caste','$mail','$mob','$insti','$guardian','$father','$mother','$adress','$line','$city','$zip','$room')";
			mysqli_query($con,$s);
